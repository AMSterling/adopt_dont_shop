...
RSpec.describe 'admin shelters index' do
  ...
  it 'displays a section listing shelters with pending applications' do
    ...
    within "#pending_apps" do
      expect(page).to have_content('Summit County')
      expect(page).to have_content('Foothills Animal Shelter')
      expect(page).to have_content('Bunny World Foundation')
      expect(page).to have_content('Aurora Shelter')
      expect(page).to_not have_content('Mystery Building')
      expect(page).to_not have_content('Heavenly Pets')
      expect(page).to_not have_content('All Animals')
    end

    within "#shelter-#{@summit.id}" do
      expect(page).to have_content('Summit County')
      expect(page).to_not have_content('Foothills Animal Shelter')
      expect(page).to_not have_content('Bunny World Foundation')
      expect(page).to_not have_content('Aurora Shelter')
    end

    within "#shelter-#{@foothills.id}" do
      expect(page).to have_content('Foothills Animal Shelter')
      expect(page).to_not have_content('Summit County')
      expect(page).to_not have_content('Bunny World Foundation')
      expect(page).to_not have_content('Aurora Shelter')
